...
Separate the execution across two concurrent tracks. Each track must outline the work for Phase 0 (research), Phase 1 (design/contracts), and Phase 2 (task generation). Reference the numbered guide requirements where relevant and highlight dependencies between tracks.

### Frontend Track
- **Phase 0**: [Research objectives, guide references]
- **Phase 1**: [Design deliverables, contracts/tests]
- **Phase 2**: [Task planning strategy]
- **Dependencies/Risks**: [What this track needs from backend]

### Backend Track
- **Phase 0**: [Research objectives, guide references]
- **Phase 1**: [Design deliverables, contracts/tests]
- **Phase 2**: [Task planning strategy]
- **Dependencies/Risks**: [What this track needs from frontend]
